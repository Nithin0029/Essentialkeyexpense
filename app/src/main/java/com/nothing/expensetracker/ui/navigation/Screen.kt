...
sealed class Screen(val route: String, val title: String, val icon: ImageVector) {
    ...
    object EditTransaction : Screen("edit_transaction/{expenseId}?initialTimestamp={initialTimestamp}", "Edit Transaction", Icons.Default.History)
    ...
    object PaymentMethodManagement : Screen("payment_method_management", "Payment Methods", Icons.Default.Settings)
    object AutopayList : Screen("autopay_list", "Autopay", Icons.Default.Settings)
    object AddEditAutopay : Screen("autopay_rule/{ruleId}", "Autopay Rule", Icons.Default.Settings)
